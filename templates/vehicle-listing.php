...
<form action="" method="get" class="vehicle_filter_form">
    ...
    <div class="single-field">
        <label for="type">Routes</label>
		<?php foreach ( $vehicle_routes as $vehicle_route ) : ?>
            <label>
                <input <?php checked( $type, $vehicle_route->slug ); ?> type="radio" name="type" value="<?php echo esc_attr( $vehicle_route->slug ); ?>">
                <span><?php echo esc_html( $vehicle_route->name ); ?></span>
            </label>
		<?php endforeach; ?>
    </div>
